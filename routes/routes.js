...
api.get('/getMyPubs/:idU',mdAuth.ensureAuth,publicationController.getMyPublications);
api.get('/getPub/:idU/:idP',mdAuth.ensureAuth,publicationController.getPublication);
